# Dockerized Flask APP Practice

This folder contains files to help practice containerizing and deploying a Flask application using Docker and AWS ECS(Fargate)

## What I practiced
- Understanding how Docker containers work
- Writing a Dockerfile for a Flask app
